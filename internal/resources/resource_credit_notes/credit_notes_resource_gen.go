...
func CreditNotesResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			"credit_note": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					...
					"balance_amount_cents": schema.Int64Attribute{
						Computed:            true,
						Description:         "The remaining credit note amount, expressed in cents.",
						MarkdownDescription: "The remaining credit note amount, expressed in cents.",
					},
					"coupons_adjustment_amount_cents": schema.Int64Attribute{
						Computed:            true,
						Description:         "The pro-rated amount of the coupons applied to the source invoice.",
						MarkdownDescription: "The pro-rated amount of the coupons applied to the source invoice.",
					},
					"created_at": schema.StringAttribute{
						Computed:            true,
						Description:         "The date when the credit note was created. It is expressed in Coordinated Universal Time (UTC).",
						MarkdownDescription: "The date when the credit note was created. It is expressed in Coordinated Universal Time (UTC).",
					},
					"credit_amount_cents": schema.Int64Attribute{
						Optional:            true,
						Computed:            true,
						Description:         "The total amount to be credited on the customer balance.",
						MarkdownDescription: "The total amount to be credited on the customer balance.",
					},
					"credit_status": schema.StringAttribute{
						Computed:            true,
						...
						MarkdownDescription: "The status of the credit portion of the credit note. It indicates the current state or condition of the credit amount associated with the credit note. The possible values for this field are:\n\n- `available`: this status indicates that an amount remains available for future usage. The credit can be applied towards future transactions or invoices.\n- `consumed`: this status indicates that the credit amount has been fully consumed. The remaining amount is 0, indicating that the credit has been utilized in its entirety.\n- `voided`: this status indicates that the remaining amount of the credit cannot be used any further. The credit has been voided and is no longer available for application or redemption.",
					},
					...
					"issuing_date": schema.StringAttribute{
						...
						MarkdownDescription: "The date of creation of the credit note. It follows the ISO 8601 date format and provides the specific date when the credit note was created.",
					},
					"items": schema.ListNestedAttribute{
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"amount_cents": schema.Int64Attribute{
									...
									MarkdownDescription: "The amount of the credit note item, expressed in cents.",
								},
								"amount_currency": schema.StringAttribute{
									Computed: true,
								},
								"fee": schema.SingleNestedAttribute{
									Attributes: map[string]schema.Attribute{
										...
										"payment_status": schema.StringAttribute{
											...
											MarkdownDescription: "Indicates the payment status of the fee. It represents the current status of the payment associated with the fee. The possible values for this field are `pending`, `succeeded`, `failed` and `refunded`.",
										},
								...
								"fee_id": schema.StringAttribute{
									Required:            true,
									Description:         "The fee unique identifier, created by Lago.",
									MarkdownDescription: "The fee unique identifier, created by Lago.",
								},
								"lago_id": schema.StringAttribute{
									Computed:            true,
									Description:         "The credit note's item unique identifier, created by Lago.",
									MarkdownDescription: "The credit note's item unique identifier, created by Lago.",
								},
							},
						...
						MarkdownDescription: "The list of credit note's items.",
					},
					"lago_id": schema.StringAttribute{
						Computed:            true,
						Description:         "The credit note unique identifier, created by Lago.",
						MarkdownDescription: "The credit note unique identifier, created by Lago.",
					},
					"lago_invoice_id": schema.StringAttribute{
						Computed:            true,
						Description:         "Unique identifier assigned to the invoice that the credit note belongs to",
						MarkdownDescription: "Unique identifier assigned to the invoice that the credit note belongs to",
					},
					"number": schema.StringAttribute{
						Computed:            true,
						Description:         "The credit note unique number.",
						MarkdownDescription: "The credit note unique number.",
					},
					"reason": schema.StringAttribute{
						...
						MarkdownDescription: "The reason of the credit note creation.\nPossible values are `duplicated_charge`, `product_unsatisfactory`, `order_change`, `order_cancellation`, `fraudulent_charge` or `other`.",
					...
					"refund_amount_cents": schema.Int64Attribute{
						Optional:            true,
						Computed:            true,
						Description:         "The total amount to be refunded to the customer.",
						MarkdownDescription: "The total amount to be refunded to the customer.",
					},
					"refund_status": schema.StringAttribute{
						Computed:            true,
						...
						MarkdownDescription: "The status of the refund portion of the credit note. It indicates the current state or condition of the refund associated with the credit note. The possible values for this field are:\n\n- `pending`: this status indicates that the refund is pending execution. The refund request has been initiated but has not been processed or completed yet.\n- `succeeded`: this status indicates that the refund has been successfully executed. The refund amount has been processed and returned to the customer or the designated recipient.\n- `failed`: this status indicates that the refund failed to execute. The refund request encountered an error or unsuccessful processing, and the refund amount could not be returned.",
					},
					"self_billed": schema.BoolAttribute{
						Computed:            true,
						...
						MarkdownDescription: "Indicates if the credit note belongs to self-billed invoice. Self-billing is a process where an organization creates the invoice on behalf of the partner.",
					},
					"sequential_id": schema.Int64Attribute{
						...
						MarkdownDescription: "The sequential identifier of the credit note, specifically scoped on the associated invoice. It provides a unique numerical identifier for the credit note within the context of the invoice.",
					},
					"sub_total_excluding_taxes_amount_cents": schema.Int64Attribute{
						...
						MarkdownDescription: "The subtotal of the credit note excluding any applicable taxes, expressed in cents.",
					},
					"taxes_amount_cents": schema.Int64Attribute{
						Computed:            true,
						Description:         "The tax amount of the credit note, expressed in cents.",
						MarkdownDescription: "The tax amount of the credit note, expressed in cents.",
					},
					"taxes_rate": schema.NumberAttribute{
						Computed:            true,
						Description:         "The tax rate associated with this specific credit note.",
						MarkdownDescription: "The tax rate associated with this specific credit note.",
					},
					"total_amount_cents": schema.Int64Attribute{
						Computed:            true,
						Description:         "The total amount of the credit note, expressed in cents.",
						MarkdownDescription: "The total amount of the credit note, expressed in cents.",
					},
					"updated_at": schema.StringAttribute{
						Computed:            true,
						Description:         "The date when the credit note was last updated. It is expressed in Coordinated Universal Time (UTC).",
						MarkdownDescription: "The date when the credit note was last updated. It is expressed in Coordinated Universal Time (UTC).",
					},
				},
				CustomType: CreditNoteType{
					ObjectType: types.ObjectType{
						AttrTypes: CreditNoteValue{}.AttributeTypes(ctx),
					},
				},
				Required: true,
			},
...
type CreditNotesModel struct {
	CreditNote CreditNoteValue `tfsdk:"credit_note"`
	LagoId     types.String    `tfsdk:"lago_id"`
}

var _ basetypes.ObjectTypable = CreditNoteType{}

type CreditNoteType struct {
	basetypes.ObjectType
}

func (t CreditNoteType) Equal(o attr.Type) bool {
	other, ok := o.(CreditNoteType)
...
func (t CreditNoteType) String() string {
	return "CreditNoteType"
}

func (t CreditNoteType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	balanceAmountCentsAttribute, ok := attributes["balance_amount_cents"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`balance_amount_cents is missing from object`)

		return nil, diags
	}

	balanceAmountCentsVal, ok := balanceAmountCentsAttribute.(basetypes.Int64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`balance_amount_cents expected to be basetypes.Int64Value, was: %T`, balanceAmountCentsAttribute))
	}

	couponsAdjustmentAmountCentsAttribute, ok := attributes["coupons_adjustment_amount_cents"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`coupons_adjustment_amount_cents is missing from object`)

		return nil, diags
	}

	couponsAdjustmentAmountCentsVal, ok := couponsAdjustmentAmountCentsAttribute.(basetypes.Int64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`coupons_adjustment_amount_cents expected to be basetypes.Int64Value, was: %T`, couponsAdjustmentAmountCentsAttribute))
	}
	...
	creditAmountCentsAttribute, ok := attributes["credit_amount_cents"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`credit_amount_cents is missing from object`)

		return nil, diags
	}

	creditAmountCentsVal, ok := creditAmountCentsAttribute.(basetypes.Int64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`credit_amount_cents expected to be basetypes.Int64Value, was: %T`, creditAmountCentsAttribute))
	}

	creditStatusAttribute, ok := attributes["credit_status"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`credit_status is missing from object`)

		return nil, diags
	}

	creditStatusVal, ok := creditStatusAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`credit_status expected to be basetypes.StringValue, was: %T`, creditStatusAttribute))
	}
	...
	refundAmountCentsAttribute, ok := attributes["refund_amount_cents"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`refund_amount_cents is missing from object`)

		return nil, diags
	}

	refundAmountCentsVal, ok := refundAmountCentsAttribute.(basetypes.Int64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`refund_amount_cents expected to be basetypes.Int64Value, was: %T`, refundAmountCentsAttribute))
	}

	refundStatusAttribute, ok := attributes["refund_status"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`refund_status is missing from object`)

		return nil, diags
	}

	refundStatusVal, ok := refundStatusAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`refund_status expected to be basetypes.StringValue, was: %T`, refundStatusAttribute))
	}
	...
	return CreditNoteValue{
		...
		BalanceAmountCents:                balanceAmountCentsVal,
		CouponsAdjustmentAmountCents:      couponsAdjustmentAmountCentsVal,
		CreatedAt:                         createdAtVal,
		CreditAmountCents:                 creditAmountCentsVal,
		CreditStatus:                      creditStatusVal,
		...
		Number:                            numberVal,
		Reason:                            reasonVal,
		RefundAmountCents:                 refundAmountCentsVal,
...
func NewCreditNoteValueNull() CreditNoteValue {
	return CreditNoteValue{
		state: attr.ValueStateNull,
	}
}

func NewCreditNoteValueUnknown() CreditNoteValue {
	return CreditNoteValue{
		state: attr.ValueStateUnknown,
	}
}

func NewCreditNoteValue(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) (CreditNoteValue, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	for name, attributeType := range attributeTypes {
		...
		if !ok {
			diags.AddError(
				"Missing CreditNoteValue Attribute Value",
				"While creating a CreditNoteValue value, a missing attribute value was detected. "+
					"A CreditNoteValue must contain values for all attributes, even if null or unknown. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("CreditNoteValue Attribute Name (%s) Expected Type: %s", name, attributeType.String()),
			)
		...
		if !attributeType.Equal(attribute.Type(ctx)) {
			diags.AddError(
				"Invalid CreditNoteValue Attribute Type",
				"While creating a CreditNoteValue value, an invalid attribute value was detected. "+
					"A CreditNoteValue must use a matching attribute type for the value. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("CreditNoteValue Attribute Name (%s) Expected Type: %s\n", name, attributeType.String())+
					fmt.Sprintf("CreditNoteValue Attribute Name (%s) Given Type: %s", name, attribute.Type(ctx)),
			)
		}
	}
	...
	for name := range attributes {
		...
		if !ok {
			diags.AddError(
				"Extra CreditNoteValue Attribute Value",
				"While creating a CreditNoteValue value, an extra attribute value was detected. "+
					"A CreditNoteValue must not contain values beyond the expected attribute types. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("Extra CreditNoteValue Attribute Name: %s", name),
			)
		}
	}

	if diags.HasError() {
		return NewCreditNoteValueUnknown(), diags
	}
...
func NewCreditNoteValueMust(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) CreditNoteValue {
	object, diags := NewCreditNoteValue(attributeTypes, attributes)
	...
	if diags.HasError() {
		...
		panic("NewCreditNoteValueMust received error(s): " + strings.Join(diagsStrings, "\n"))
	}

	return object
}

func (t CreditNoteType) ValueFromTerraform(ctx context.Context, in tftypes.Value) (attr.Value, error) {
	if in.Type() == nil {
		return NewCreditNoteValueNull(), nil
	}
	...
	if !in.IsKnown() {
		return NewCreditNoteValueUnknown(), nil
	}
	...
	return NewCreditNoteValueMust(CreditNoteValue{}.AttributeTypes(ctx), attributes), nil
}

func (t CreditNoteType) ValueType(ctx context.Context) attr.Value {
	return CreditNoteValue{}
}

var _ basetypes.ObjectValuable = CreditNoteValue{}

type CreditNoteValue struct {
	AppliedTaxes                      basetypes.ListValue   `tfsdk:"applied_taxes"`
	BalanceAmountCents                basetypes.Int64Value  `tfsdk:"balance_amount_cents"`
	CouponsAdjustmentAmountCents      basetypes.Int64Value  `tfsdk:"coupons_adjustment_amount_cents"`
	CreatedAt                         basetypes.StringValue `tfsdk:"created_at"`
	CreditAmountCents                 basetypes.Int64Value  `tfsdk:"credit_amount_cents"`
	CreditStatus                      basetypes.StringValue `tfsdk:"credit_status"`
	...
	RefundAmountCents                 basetypes.Int64Value  `tfsdk:"refund_amount_cents"`
	RefundStatus                      basetypes.StringValue `tfsdk:"refund_status"`
...
func (v CreditNoteValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["balance_amount_cents"] = basetypes.Int64Type{}.TerraformType(ctx)
	attrTypes["coupons_adjustment_amount_cents"] = basetypes.Int64Type{}.TerraformType(ctx)
	attrTypes["created_at"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["credit_amount_cents"] = basetypes.Int64Type{}.TerraformType(ctx)
	attrTypes["credit_status"] = basetypes.StringType{}.TerraformType(ctx)
	...
	attrTypes["refund_amount_cents"] = basetypes.Int64Type{}.TerraformType(ctx)
	attrTypes["refund_status"] = basetypes.StringType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.BalanceAmountCents.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["balance_amount_cents"] = val

		val, err = v.CouponsAdjustmentAmountCents.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["coupons_adjustment_amount_cents"] = val
		...
		val, err = v.CreditAmountCents.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["credit_amount_cents"] = val

		val, err = v.CreditStatus.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["credit_status"] = val
		...
		val, err = v.RefundAmountCents.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["refund_amount_cents"] = val

		val, err = v.RefundStatus.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["refund_status"] = val
...
func (v CreditNoteValue) IsNull() bool {
	return v.state == attr.ValueStateNull
}

func (v CreditNoteValue) IsUnknown() bool {
	return v.state == attr.ValueStateUnknown
}

func (v CreditNoteValue) String() string {
	return "CreditNoteValue"
}

func (v CreditNoteValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	attributeTypes := map[string]attr.Type{
		...
		"balance_amount_cents":            basetypes.Int64Type{},
		"coupons_adjustment_amount_cents": basetypes.Int64Type{},
		"created_at":                      basetypes.StringType{},
		"credit_amount_cents":             basetypes.Int64Type{},
		"credit_status":                   basetypes.StringType{},
		...
		"refund_amount_cents":                    basetypes.Int64Type{},
		"refund_status":                          basetypes.StringType{},
	...
	objVal, diags := types.ObjectValue(
		...
		map[string]attr.Value{
			...
			"balance_amount_cents":                   v.BalanceAmountCents,
			"coupons_adjustment_amount_cents":        v.CouponsAdjustmentAmountCents,
			"created_at":                             v.CreatedAt,
			"credit_amount_cents":                    v.CreditAmountCents,
			"credit_status":                          v.CreditStatus,
			"currency":                               v.Currency,
...
func (v CreditNoteValue) Equal(o attr.Value) bool {
	other, ok := o.(CreditNoteValue)
	...
	if !v.BalanceAmountCents.Equal(other.BalanceAmountCents) {
		return false
	}

	if !v.CouponsAdjustmentAmountCents.Equal(other.CouponsAdjustmentAmountCents) {
		return false
	}
	...
	if !v.CreditAmountCents.Equal(other.CreditAmountCents) {
		return false
	}

	if !v.CreditStatus.Equal(other.CreditStatus) {
		return false
	}
	...
	if !v.RefundAmountCents.Equal(other.RefundAmountCents) {
		return false
	}

	if !v.RefundStatus.Equal(other.RefundStatus) {
		return false
	}
...
func (v CreditNoteValue) Type(ctx context.Context) attr.Type {
	return CreditNoteType{
		basetypes.ObjectType{
...
func (v CreditNoteValue) AttributeTypes(ctx context.Context) map[string]attr.Type {
...
func (t ItemsType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	feeAttribute, ok := attributes["fee"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`fee is missing from object`)

		return nil, diags
	}

	feeVal, ok := feeAttribute.(basetypes.ObjectValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`fee expected to be basetypes.ObjectValue, was: %T`, feeAttribute))
	}

	feeIdAttribute, ok := attributes["fee_id"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`fee_id is missing from object`)

		return nil, diags
	}

	feeIdVal, ok := feeIdAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`fee_id expected to be basetypes.StringValue, was: %T`, feeIdAttribute))
	}
...
type ItemsValue struct {
	AmountCents    basetypes.Int64Value  `tfsdk:"amount_cents"`
	AmountCurrency basetypes.StringValue `tfsdk:"amount_currency"`
	Fee            basetypes.ObjectValue `tfsdk:"fee"`
	FeeId          basetypes.StringValue `tfsdk:"fee_id"`
	LagoId         basetypes.StringValue `tfsdk:"lago_id"`
	state          attr.ValueState
}
...
func (v ItemsValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["amount_cents"] = basetypes.Int64Type{}.TerraformType(ctx)
	attrTypes["amount_currency"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["fee"] = basetypes.ObjectType{
		AttrTypes: FeeValue{}.AttributeTypes(ctx),
	}.TerraformType(ctx)
	attrTypes["fee_id"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["lago_id"] = basetypes.StringType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.Fee.ToTerraformValue(ctx)
		...
		val, err = v.FeeId.ToTerraformValue(ctx)
...
func (v ItemsValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	var fee basetypes.ObjectValue

	if v.Fee.IsNull() {
		fee = types.ObjectNull(
			FeeValue{}.AttributeTypes(ctx),
		)
	}

	if v.Fee.IsUnknown() {
		fee = types.ObjectUnknown(
			FeeValue{}.AttributeTypes(ctx),
		)
	}

	if !v.Fee.IsNull() && !v.Fee.IsUnknown() {
		fee = types.ObjectValueMust(
			FeeValue{}.AttributeTypes(ctx),
			v.Fee.Attributes(),
		)
	}
	...
	attributeTypes := map[string]attr.Type{
		"amount_cents":    basetypes.Int64Type{},
		"amount_currency": basetypes.StringType{},
		"fee": basetypes.ObjectType{
			AttrTypes: FeeValue{}.AttributeTypes(ctx),
		},
		"fee_id":  basetypes.StringType{},
		"lago_id": basetypes.StringType{},
	}
...
func (v ItemsValue) Equal(o attr.Value) bool {
	...
	if !v.Fee.Equal(other.Fee) {
		return false
	}

	if !v.FeeId.Equal(other.FeeId) {
		return false
	}
